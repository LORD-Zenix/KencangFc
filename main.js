...
conn.connect().then(() => {
 conn.sendMessage('6285701863281@c.us', '[Bot Sudah Siap Di Gunakan]', 'conversation');
...
global.reloadHandler = function () {
  ...
  conn.spromote = '@user Ciee Sekarang Dah Jadi Admin!'
  conn.sdemote = '@user Awokawok Di UnAdmin!'
